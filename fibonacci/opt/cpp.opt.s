fib:
	...
	106:	cmp    rax,0x1
	110:	je     1505 <fib+0x215>
	116:	mov    QWORD PTR [rsp+0x40],0x0
	123:	
	125:	mov    rax,QWORD PTR [rsp+0x10]
	130:	lea    r9,[rax-0x1]
	134:	cmp    r9,0x1
	138:	je     159f <fib+0x2af>
	144:	lea    r12,[r9-0x1]
	148:	xor    r15d,r15d
	151:	cmp    r12,0x1
	155:	je     1594 <fib+0x2a4>
	161:	lea    rbx,[r12-0x1]
	166:	xor    edx,edx
	168:	cmp    rbx,0x1
	172:	je     158a <fib+0x29a>
	178:	cmp    rbx,0x2
	182:	je     1573 <fib+0x283>
	188:	lea    r13,[rbx-0x3]
	192:	lea    rsi,[rbx-0x6]
	196:	xor    r8d,r8d
	199:	mov    rax,r13
	...
	223:	je     1466 <fib+0x176>
	229:	lea    r14,[rbp-0x1]
	233:	xor    r11d,r11d
	236:	cmp    r14,0x1
	240:	je     1580 <fib+0x290>
	246:	lea    rdi,[r14-0x1]
	...
	378:	add    r8,rbp
	381:	cmp    rsi,r10
	384:	jne    13c5 <fib+0xd5>
	390:	and    r13d,0x1
	394:	lea    rax,[r13+r8*1+0x0]
	399:	sub    rbx,0x2
	403:	add    rdx,rax
	406:	cmp    rbx,0x1
	410:	jg     13a2 <fib+0xb2>
	416:	lea    rax,[r12-0x3]
	421:	and    eax,0x1
	424:	add    rax,rdx
	427:	sub    r12,0x2
	...
	642:	ret    
	643:	mov    eax,0x1
	648:	jmp    147f <fib+0x18f>
	653:	nop    DWORD PTR [rax]
	656:	mov    eax,0x1
	661:	jmp    144c <fib+0x15c>
	666:	mov    eax,0x1
	671:	jmp    149b <fib+0x1ab>
	676:	mov    r15d,0x1
	682:	jmp    14b6 <fib+0x1c6>
	687:	mov    eax,0x1
	692:	jmp    14da <fib+0x1ea>
